...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "PlayerReceiveSM.h"
// the name of the Init function
#define SERV_1_INIT InitPlayerReceiveSM
// the name of the run function
#define SERV_1_RUN RunPlayerReceiveSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "PlayerBrainSM.h"
// the name of the Init function
#define SERV_2_INIT InitPlayerBrainSM
// the name of the run function
#define SERV_2_RUN RunPlayerBrainSM
// How big should this services Queue be?
#define SERV_2_QUEUE_SIZE 7
#endif
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "PlayerTransmitSM.h"
// the name of the Init function
#define SERV_3_INIT InitPlayerTransmitSM
// the name of the run function
#define SERV_3_RUN RunPlayerTransmitSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public fuction prototypes
#define SERV_4_HEADER "PlayerLiFKIM.h"
// the name of the Init function
#define SERV_4_INIT InitPlayerLiFKIM
// the name of the run function
#define SERV_4_RUN RunPlayerLiFKIM
// How big should this services Queue be?
...
typedef enum {  ES_NO_EVENT = 0,
                ...
                ES_LOCK,
                ES_UNLOCK, Status_Update, STOP, Charging_Field_Fwd, 
                Finding_Wall_Fwd, Going_To_Start_FWD, 
                Going_To_Start_RVS, Finding_Wall_RVS, 
                Charging_Field_RVS, TRANSMIT, RECEIVE, TRIGGER1, TRIGGER2, COLOR_ERROR, ACCEPT_PAIR,
                DENY_PAIR, TIME_OUT, RESET, SHUTDOWN, TAG_DETECTED, TAG_OUT, ALREADY_PAIRED, COACH_CALL,
                LiFKIM_STATUS, GET_STATUS, START_ENGINE, TAG_CALL, SHUT_OFF, TOO_LONG, GO_TO_PAIR, GOOD_CALL,
                CAN_TRANSMIT, PUSH  } ES_EventTyp_t ;
...
#define EVENT_CHECK_LIST Check4Keystroke, CheckForTransmit, CheckReception 
...
#define TIMER0_RESP_FUNC PostPlayerReceiveSM
#define TIMER1_RESP_FUNC PostPlayerLiFKIM
#define TIMER2_RESP_FUNC PostPlayerBrainSM
